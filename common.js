document.addEventListener("DOMContentLoaded", function () {
    ...
    // If the essential SVG elements are on the page, proceed with rendering
    if (hourIndicatorsGroup) {
        hours.forEach((hour, index) => {
            const angle = ((index + 1) * 30) * (Math.PI / 180);  // Corrected the index here
        ...
        console.log("Essential SVG elements like 'hourIndicatorsGroup' are not found on this page.");
    }
